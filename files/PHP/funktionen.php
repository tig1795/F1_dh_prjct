...
<!DOCTYPE html>
  ...
  <div class="menu-bar">
    <div class="logo">
      <a href="Home.php"><img src="../../images/F1_Logo.png" alt="" width="120" height="65"/></a>
      </div>
    <ul>
EOH;
...
print <<<EOH
<a href="#"><i class="fa fa-book" aria-hidden="true"></i>Statistik</a>
...
<a href="#"><i class="fa fa-newspaper-o" aria-hidden="true"></i> Fahrer</a>
        <div class="sub-menu-1">
          <ul>
...
print <<<EOH
<a href="#"><i class="fa fa-users" aria-hidden="true"></i>Trophäen</a>
        <div class="sub-menu-1">
          <ul>
...
print <<<EOH
	  ...
	  <a href="#"><i class="fa fa-play" aria-hidden="true"></i> Renn</a>
        <div class="sub-menu-1">
            <ul>
...
print <<<EOH
<a href="#"><i class="fa fa-heart" aria-hidden="true"></i>About</a></li>
EOH;
